...
public class Win32_GroupImpl extends WmiObjImpl implements Win32_Group {
  public Win32_GroupImpl(ActiveXComponent activeXComponent) {
    super(activeXComponent);
  }
  public Win32_GroupImpl(ActiveXComponent activeXComponent, Wmi wmi) {
    super(activeXComponent, wmi);
  }
  public Win32_GroupImpl(GetActiveXComponent activeXComponent) {
    super(activeXComponent.getActiveXComponent());
  }
  public Win32_GroupImpl(GetActiveXComponent activeXComponent, Wmi wmi) {
