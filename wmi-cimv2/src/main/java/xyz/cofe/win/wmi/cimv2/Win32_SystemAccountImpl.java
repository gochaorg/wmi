...
public class Win32_SystemAccountImpl extends WmiObjImpl implements Win32_SystemAccount {
  public Win32_SystemAccountImpl(ActiveXComponent activeXComponent) {
    super(activeXComponent);
  }
  public Win32_SystemAccountImpl(ActiveXComponent activeXComponent, Wmi wmi) {
    super(activeXComponent, wmi);
  }
  public Win32_SystemAccountImpl(GetActiveXComponent activeXComponent) {
    super(activeXComponent.getActiveXComponent());
  }
  public Win32_SystemAccountImpl(GetActiveXComponent activeXComponent, Wmi wmi) {
